...
//        return y;
    ...
    public void testSyllables() throws Exception {
        ...
        assertEquals(Arrays.toString(exps.get(0).toArray()), Arrays.toString(syllables1.toArray()));
        assertEquals(Arrays.toString(exps.get(1).toArray()), Arrays.toString(syllables2.toArray()));
    }
